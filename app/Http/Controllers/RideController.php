...
class RideController extends Controller
{
    ...
    public
        ...
        $request->validate([
            ...
            'pickup_location' =>
                'required|string|max:100', // Não vazio, máx 100 chars
            ...
            'departure_time' =>
                'required|date_format:H:i', // HH:MM

            'total_seats' =>
                'required|integer|min:1|max:8' // 1-8 lugares
...
if (auth()->user()->role === 'passenger') {
    ...
    public
        ...
        $ride =
            Ride::findOrFail($rideRequest->ride_id);
