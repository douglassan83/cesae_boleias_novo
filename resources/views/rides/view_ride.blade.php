                        ...
                        <div class="card-body">
                            @forelse ($requests as $request)
                                ...
                                <div class="row mb-3 p-2 border-bottom">
                                    ...
                                    {{-- STATUS --}}
                                    <div class="col-6 col-md-2 d-flex align-items-center justify-content-start justify-content-md-center mb-2 mb-md-0">
                                    ...
                                    {{-- BOTÕES --}}
                                    <div class="col-6 col-md-5 d-flex flex-column flex-md-row align-items-end align-items-md-center justify-content-end text-end">
                                        @if ($request->status === 'pending')
                                            <div class="btn-group btn-group-sm gap-2 mb-2 mb-md-0 w-100 w-md-auto">
                                                <form method="POST" action="{{ route('ride_requests.accept', $request->id) }}" class="d-inline">
                                                    @csrf
                                                    <button type="submit" class="btn btn-success btn-sm w-100 w-md-auto">Aceitar</button>
                                                </form>
                                        ...
                                        @if ($request->status === 'accepted' && $request->teams_link)
                                            <a href="{{ $request->teams_link }}" target="_blank" class="teams-btn mt-1 mt-md-2">
