...
@section('content')
    <div class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="card shadow" style="width: 700px; min-height: 600px;">
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('rides.store') }}">
                    ...
                    {{-- Lugares --}}
                    <div class="mb-3">
                        <label class="form-label">Lugares Totais (1–8)</label>
                        <input type="number" name="total_seats" class="form-control" min="1" max="8"
                            required>
                    </div>
